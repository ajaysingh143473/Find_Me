...
class finepage(models.Model):
    ...
    fash=models.CharField(max_length=5)
    homefurt=models.CharField(max_length=5)
    elec=models.CharField(max_length=5)
    boook=models.CharField(max_length=5)
    groseries=models.CharField(max_length=5)
