...
urlpatterns = [
    ...
    path('fashion/',views.fashion1,name='fashion1'),
    path('homefurt/',views.homefurt1,name='homefurt1'),
    path('elec/',views.elec1,name='elec1'),
    path('books/',views.book,name='elec1'),
    path('gros/',views.grw,name='elec1'),
